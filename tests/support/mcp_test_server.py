"""MCP test server shared by transport and integration tests.
Minimal MCP server using only Python standard library (no mcp package).
Run: python tests/support/mcp_test_server.py           # stdio (default)
     python tests/support/mcp_test_server.py --sse     # SSE on http://127.0.0.1:8765/sse
