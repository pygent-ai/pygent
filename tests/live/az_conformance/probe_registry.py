    ...
    return ProbeRegistry(
        {
            ...
            ("openai_embeddings", Scenario.EMBEDDING): embedding_probe,
            ("openai_images", Scenario.IMAGE_OUTPUT): image_output_probe,
            ("openai_images", Scenario.IMAGE_EDIT): image_edit_probe,
            ("openai_audio_speech", Scenario.AUDIO_OUTPUT): audio_output_probe,
            ("openai_realtime", Scenario.REALTIME): realtime_probe,
            ("openai_realtime", Scenario.TOOLS): realtime_probe,
            ("openai_realtime", Scenario.TOOL_CHOICE): realtime_probe,
            ("openai_realtime", Scenario.REASONING): realtime_probe,
            ("openai_realtime", Scenario.IMAGE_INPUT): realtime_probe,
            ("openai_realtime", Scenario.AUDIO_INPUT): audio_input_probe,
            ("openai_realtime", Scenario.AUDIO_OUTPUT): audio_output_probe,
