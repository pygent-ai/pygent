...
| 基础 Context 不可变、模型投影、显式历史、slot、严格有限 JSON 与 wire 往返 | `tests/integration/test_module_context_contract.py`、`tests/core/test_json_values.py`、`tests/runtime/test_wire_codec.py` |
